...
,
    _parseMdl(buf) {
        ...
        // 顶点 stride: 头部 u32 (材料串后第 29 字节, 如 0x0180000f) 的高 16 位
        // 编码布局: 0x0180 → 80B (pos/normal/tangent/blendIdx/blendW/uv),
        //            0x0181 → 84B (blendIdx 前多 4B, uv/blend 偏移 +4)
        // 两种 stride 的字段偏移都从尾部推导: uv@S-8, blendW@S-24, blendIdx@S-40
        let found = null;
        ...
        // 字段偏移从 stride 尾部推导 (84B = 80B + blendIdx 前 4B):
        // uv@S-8, blendW@S-24, blendIdx@S-40, pos@0
