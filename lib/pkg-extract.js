...
function extractSceneMainImage(pkgData) {
  return capFallbackFrame(extractSceneMainImageVia(pkgSceneAccess(pkgData), 'pkg'), FALLBACK_MAX_WIDTH);
}
...
function extractSceneMainImageFromDir(dir) {
  return capFallbackFrame(extractSceneMainImageVia(dirSceneAccess(dir), 'scene'), FALLBACK_MAX_WIDTH);
}
