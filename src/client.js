...
// This round: v0.7.3 adds two user-facing controls (壁纸透明度 #82 / 输入光标颜色
// #83) and fixes custom-upload wallpapers (#84) — an upload without a rating was
...
// claim 「播放中」 even when <video> had refused to start. It also carries the
// merged community fixes: the composer-glass containing-block fix (#89) and the
// honest sceneVideo field (#92).
...
function UpdateNotice() {
  ...
  return React.createElement("div", { className: "we-update-notice", role: "alert" },
    React.createElement("div", { className: "we-update-notice__title" }, "✨ v0.7.3：壁纸透明度 · 输入光标颜色 · 自上传壁纸修复"),
    React.createElement("div", { className: "we-update-notice__body" },
      React.createElement("p",
        null,
        "本版本新增两个可调项，并修复自上传壁纸的两处关键问题："),
      React.createElement("p",
        null,
      ...
      React.createElement("p",
        null,
        "另合并了社区贡献：输入框玻璃的定位修复（#89）与场景内嵌视频字段的诚实化（#92）。"),
